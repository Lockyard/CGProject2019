...
// Since the game is basically in 2D, camdir contains the rotation about the y-axis to orient the car    
    /*var rotworld = utils.MakeRotateYMatrix(cardir*Math.PI/180);
    var transworld = utils.MakeTranslateMatrix(carx, cary, carz);

	//var world = utils.multiplyMatrices(transworld,rotworld);
    var world = utils.multiplyMatrices(rotworld, transworld);*/
...
// aspectRatio, a vertical Fov-y of 60 degrees, and with near and far planes repsectively at 0.1 and 1000.0
    ...
    var projection = utils.MakePerspective(fov,a,n,f);
