...
function updateWorld(rvx, rvy, rvz) {
	...
	var quatX = new Quaternion(Math.cos(rvx), Math.sin(rvx), 0, 0);
	var quatY = new Quaternion(Math.cos(rvy), 0, Math.sin(rvy), 0);
	var quatZ = new Quaternion(Math.cos(rvz), 0, 0, Math.sin(rvz));
